...
class Measure:
    ...
    def visuals(self):
        ...
        if len(self.inter_points) > 0:
            ...
            cv2.line(self.images, self.inter_points[0], self.inter_points[1], (20, 200, 20), 1)  # 1-2
            cv2.line(self.images, self.inter_points[0], self.inter_points[2], (20, 200, 20), 1)  # 1-3
            cv2.line(self.images, self.inter_points[1], self.inter_points[3], (20, 200, 20), 1)  # 2-4
            cv2.line(self.images, self.inter_points[2], self.inter_points[3], (20, 200, 20), 1)  # 3-4

            cv2.line(self.images, self.inter_points[4], self.inter_points[5], (20, 200, 20), 1)  # 5-6
            cv2.line(self.images, self.inter_points[4], self.inter_points[6], (20, 200, 20), 1)  # 5-7
            cv2.line(self.images, self.inter_points[5], self.inter_points[7], (20, 200, 20), 1)  # 6-8
            cv2.line(self.images, self.inter_points[6], self.inter_points[7], (20, 200, 20), 1)  # 7-8

            cv2.line(self.images, self.inter_points[0], self.inter_points[4], (20, 200, 20), 1)  # 1-5
            cv2.line(self.images, self.inter_points[1], self.inter_points[5], (20, 200, 20), 1)  # 2-6
            cv2.line(self.images, self.inter_points[2], self.inter_points[6], (20, 200, 20), 1)  # 3-7
            cv2.line(self.images, self.inter_points[3], self.inter_points[7], (20, 200, 20), 1)  # 4-8
    ...
    @staticmethod
    def calc_2plane_inter(plane1, plane2):
        """
    ...
    def keyboard_clicks(self):
        ...
        if key == ord("c"):  # calculate cuboid
            cube = pyrsc.Cuboid()
            best_eq, best_inliers = cube.fit(np.array(self.points_3d_buffer_list), thresh=3*10**-3, maxIteration=10000)
            ...
            pcd_good = pcd.select_by_index(best_inliers)
            ...
            pcd_bbox = pcd = o3d.geometry.PointCloud()
